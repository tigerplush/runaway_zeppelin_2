The Zeppelin is the moving base of the player. It houses everything and is the most valuable resource as well as the "Main Character".

The first available Zeppelin is modelled after the LZ127 and has 36 crew members and up to 24 passengers.
There are other Zeppelin models available the player can buy with meta progression currency.

Historic Zeppelins cruised at 200m to 1000m altitude with an operational ceiling of 4000m to 6000m. The higher a zeppelin rises, the higher the visibility, but also fuel consumption rises.

# Upgrades
With the correct specialists on board, it is possible to upgrade cargo space into different other rooms: Garden/Hydroponics to grow food (consumes enormous amounts of water and brings little food), Workshop (make new spare parts from scrap), etc.

# Hull stress / Structural integrity
Landing the zeppelin at a POI is a dangerous thing. Historically, landing a zeppelin required a 40+ person ground crew; alone in the strange lands, every landing risks damage unless mitigated by upgrades. The player has to balance landing the zeppelin with the still available resource.
On every landing, depending on how well it went, a few parts of the zeppelin will be damaged. This could be water or fuel tanks where then water will slowly leak out, fuel or lifting gas cells, where gas will vent out, engines or the frame of the zeppelin itself. The zeppelin stocks a few replacement parts and repair tools at start, but these will slowly run out.

On some structures, the Zeppelin can moor, which is far less dangerous.
