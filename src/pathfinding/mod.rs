...
impl Pathfinder {
    ...
    fn calculate_step(&mut self) -> PathfindingState {
...
fn calculate_paths(query: Query<&Pathfinder>) {
    for pathfinder in &query {}
}
...
#[cfg(test)]
mod test {
    use crate::{pathfinding::{Pathfinder, PathfindingState}, utils::hex::AxialCoordinates};
    ...
    fn test_pathfinding() {
        ...
        assert_eq!(pathfinding.calculate_step(), PathfindingState::Completed(vec![AxialCoordinates::ZERO, AxialCoordinates::RIGHT]));
    }
    ...
    fn test_longer_pathfinding() {
        ...
        assert_eq!(pathfinding.calculate_step(), PathfindingState::Calculating);
        assert_eq!(pathfinding.calculate_step(), PathfindingState::Calculating);
        assert_eq!(pathfinding.calculate_step(), PathfindingState::Completed(vec![AxialCoordinates::ZERO, AxialCoordinates::new(1, 0), AxialCoordinates::new(2, 0,)]));
    }
}